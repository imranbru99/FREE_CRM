...
<head>
    ...
    <title>{{ config('app.name', 'FREE_CRM_Software') }} — @yield('title')</title>
                ...
                <div x-show="!sidebarCollapsed" class="mb-4 p-3 rounded-2xl bg-slate-50 dark:bg-white/5 border border-slate-100 dark:border-white/5">
                    <div class="flex items-center gap-3">
                        ...
                        <div class="overflow-hidden">
                            ...
                            <p class="text-[10px] text-slate-400 uppercase tracking-tighter">{{ auth()->user()->roles->pluck('name')->join(', ') }}</p>
                        </div>
                    </div>
                </div>
