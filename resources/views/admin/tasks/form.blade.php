        ...
        <div class="glass-panel rounded-3xl p-8 shadow-xl space-y-6">
            <div class="space-y-2">
                ...
                <input type="text" name="title" value="{{ old('title', $task->title ?? '') }}"
                       class="w-full px-4 py-3 bg-slate-50 dark:bg-white/5 border border-slate-200 dark:border-white/10 rounded-2xl focus:ring-2 ring-blue-500/20 outline-none" required>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="space-y-2">
                    ...
                    <select name="customer_id" class="w-full px-4 py-3 bg-slate-50 dark:bg-white/5 border border-slate-200 dark:border-white/10 rounded-2xl focus:ring-2 ring-blue-500/20 outline-none">
            ...
            <div class="space-y-2">
                ...
                <div class="grid grid-cols-3 gap-4">
                    ...
                    <label class="cursor-pointer">
                        ...
                        <div class="px-4 py-3 text-center border border-slate-200 dark:border-white/10 rounded-2xl peer-checked:bg-blue-600 peer-checked:text-white peer-checked:border-blue-600 transition-all text-sm font-medium capitalize text-slate-500">
            ...
            <div class="space-y-2">
                ...
                <textarea name="description" rows="4" class="w-full px-4 py-3 bg-slate-50 dark:bg-white/5 border border-slate-200 dark:border-white/10 rounded-2xl focus:ring-2 ring-blue-500/20 outline-none">{{ old('description', $task->description ?? '') }}</textarea>
            </div>
